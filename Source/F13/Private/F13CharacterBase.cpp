...
void AF13CharacterBase::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    {
        if (IA_Move)   EnhancedInput->BindAction(IA_Move, ETriggerEvent::Triggered, this, &AF13CharacterBase::Move);
        if (IA_Look)   EnhancedInput->BindAction(IA_Look, ETriggerEvent::Triggered, this, &AF13CharacterBase::Look);
        if (IA_Jump)
        {
...
void AF13CharacterBase::JumpPressed(const FInputActionValue&) { Jump(); }
void AF13CharacterBase::JumpReleased(const FInputActionValue&) { StopJumping(); }

void AF13CharacterBase::SprintPressed(const FInputActionValue&)
{
    bIsSprinting = true;
...
void AF13CharacterBase::SprintReleased(const FInputActionValue&)
{
    bIsSprinting = false;
...
void AF13CharacterBase::OnRep_IsSprinting()
{
    if (bIsSprinting)
    {
        MoveComp->MaxWalkSpeed = SprintSpeed;
...
bool AF13CharacterBase::ServerSetSprinting_Validate(bool bNewSprinting)
{
    return true;
}

void AF13CharacterBase::ServerSetSprinting_Implementation(bool bNewSprinting)
{
