...
#include "PantheonKillerCharacter.h"
...
FClassRegistrationInfo Z_Registration_Info_UClass_APantheonKillerCharacter;
UClass* APantheonKillerCharacter::GetPrivateStaticClass()
{
	using TClass = APantheonKillerCharacter;
	if (!Z_Registration_Info_UClass_APantheonKillerCharacter.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("PantheonKillerCharacter"),
			Z_Registration_Info_UClass_APantheonKillerCharacter.InnerSingleton,
			StaticRegisterNativesAPantheonKillerCharacter,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_APantheonKillerCharacter.InnerSingleton;
}
UClass* Z_Construct_UClass_APantheonKillerCharacter_NoRegister()
{
	return APantheonKillerCharacter::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_joelb_source_repos_SOTP_Source_Pantheon_Public_PantheonKillerCharacter_h__Script_Pantheon_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APantheonKillerCharacter, APantheonKillerCharacter::StaticClass, TEXT("APantheonKillerCharacter"), &Z_Registration_Info_UClass_APantheonKillerCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APantheonKillerCharacter), 1608180654U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_joelb_source_repos_SOTP_Source_Pantheon_Public_PantheonKillerCharacter_h__Script_Pantheon_2200844203(TEXT("/Script/Pantheon"),
	Z_CompiledInDeferFile_FID_Users_joelb_source_repos_SOTP_Source_Pantheon_Public_PantheonKillerCharacter_h__Script_Pantheon_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_joelb_source_repos_SOTP_Source_Pantheon_Public_PantheonKillerCharacter_h__Script_Pantheon_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
