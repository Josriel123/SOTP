...
PANTHEON_API UClass* Z_Construct_UClass_APantheonPlayerState();
...
void FOnCharacterSelectedSignature_DelegateWrapper(const FMulticastScriptDelegate& OnCharacterSelectedSignature, APlayerController* SelectingPC)
{
	...
	_Script_Pantheon_eventOnCharacterSelectedSignature_Parms Parms;
...
{
	((_Script_Pantheon_eventOnReadyChanged_Parms*)Obj)->bNowReady = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_Pantheon_OnReadyChanged__DelegateSignature_Statics::NewProp_bNowReady = { "bNowReady", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(_Script_Pantheon_eventOnReadyChanged_Parms), &Z_Construct_UDelegateFunction_Pantheon_OnReadyChanged__DelegateSignature_Statics::NewProp_bNowReady_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Pantheon_OnReadyChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Pantheon_OnReadyChanged__DelegateSignature_Statics::NewProp_PlayerState,
...
void FOnReadyChanged_DelegateWrapper(const FMulticastScriptDelegate& OnReadyChanged, APantheonPlayerState* PlayerState, bool bNowReady)
{
	...
	_Script_Pantheon_eventOnReadyChanged_Parms Parms;
